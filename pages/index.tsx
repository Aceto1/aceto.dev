...
const Home: NextPage = () => {
  return (
    <div className={styles.container}>
      ...
      <p>I&apos;m a 25 year old software developer living near Cologne, Germany. I&apos;m currently studying computer science while working as a .NET developer at a small company.</p>
